...
{
    public sealed class ChairInstance : IInteractable, IBaseSupportedWorldObject, IFurniture
    {
        private readonly int tileSize;

        public ChairInstance(Point tile, int tileSize, bool facingLeft = false)
        {
            Tile = tile;
        ...
        public Vector2 Position
        {
            get
            {
                int x = (Tile.X * tileSize) + ((tileSize - 8) / 2);
