...
namespace Nyvorn.Source.Engine.Input
{
    public readonly struct InputState
    {
        ...
        public InputState(int moveDir, bool jumpPressed, bool attackPressed, bool placePressed, bool openInventoryPressed, int hotbarSelectionIndex, bool dodgePressed, int dodgeDir, Vector2 mouseScreenPosition)
        {
            MoveDir = moveDir;
        ...
        {
            return new InputState(MoveDir, JumpPressed, false, false, OpenInventoryPressed, HotbarSelectionIndex, DodgePressed, DodgeDir, MouseScreenPosition);
        }
    }
}
