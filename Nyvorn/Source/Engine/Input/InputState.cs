...
namespace Nyvorn.Source.Engine.Input
{
    public readonly struct InputState
    {
        ...
        public InputState(int moveDir, bool jumpPressed, bool attackPressed, bool placePressed, bool openInventoryPressed, bool tissueRevealPressed, bool toggleMinimapPressed, int hotbarSelectionIndex, bool dodgePressed, int dodgeDir, Vector2 mouseScreenPosition, int mouseWheelDelta)
        {
            MoveDir = moveDir;
        ...
        {
            return new InputState(MoveDir, JumpPressed, false, false, OpenInventoryPressed, TissueRevealPressed, ToggleMinimapPressed, HotbarSelectionIndex, DodgePressed, DodgeDir, MouseScreenPosition, MouseWheelDelta);
        }
    }
}
