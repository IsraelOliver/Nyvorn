...
{
    public sealed class PlayerCreationState : IGameState
    {
        ...
        public PlayerCreationState(GraphicsDevice graphicsDevice, ContentManager content, StateMachine stateMachine)
        {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (confirmPressed)
            {
                PlayerSaveData created = saveService.CreatePlayer(playerName);
                saveService.SetLastSelectedPlayerId(created.PlayerId);
                ReturnToPlayerSelect();
                previousKeyboard = keyboard;
                previousMouse = mouse;
                return;
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            Rectangle createBounds = GetCreateButtonBounds();
            ...
            spriteBatch.DrawString(font, "Novo Jogador", titlePos, new Color(255, 241, 193));
            string wrappedSubtitle = TextLayout.WrapText(font, "Escolha um nome para o novo personagem.", panel.Width - 56);
            ...
            DrawButton(spriteBatch, createBounds, "Criar", new Color(255, 241, 193), new Color(16, 31, 36));
        ...
        private void DrawButton(SpriteBatch spriteBatch, Rectangle bounds, string label, Color fill, Color textColor)
        {
            ...
            Color border = bounds == GetCreateButtonBounds() ? new Color(143, 211, 255, 180) : new Color(143, 211, 255, 120);
