...
namespace Nyvorn.Source.Game.States
{
    public sealed class PlayingSessionFactory
    {
        ...
        private BuildOperation CreateBuildOperation(PlanetWorldMetadata planetMetadata, IReadOnlyCollection<WorldTileChange> tileChanges)
        {
            ...
            WorldGenConfig worldGenConfig = null;
            ...
            operation = new BuildOperation(new[]
            {
                new BuildOperation.BuildStep("Carregando blocos e configuracoes", () =>
                {
                    ...
                    sand = content.Load<Texture2D>("blocks/sand_spritesheet");
                    stone = content.Load<Texture2D>("blocks/stone_spritesheet");

                    worldGenConfig = WorldGenConfig.CreatePreset(planetMetadata.SizePreset, planetMetadata.Seed);
                    worldMap = new WorldMap(worldGenConfig.WorldWidth, worldGenConfig.WorldHeight, worldGenConfig.TileSize);
                    worldMap.SetTextures(dirt, grass, sand, stone);
                    worldGenerator = new WorldGenerator();
                }),
                new BuildOperation.BuildStep("Gerando terreno base", () =>
                {
                    worldGenerator.Generate(worldMap, worldGenConfig);
                }),
                new BuildOperation.BuildStep("Preparando mundo para jogo", () =>
                {
                    playerSpawnTileX = worldGenConfig.SpawnApproximateTileX;
                ...
                {
                    tissueNetwork = new TissueGenerator(worldGenConfig.Seed).Generate(worldMap);
                }),
                new BuildOperation.BuildStep("Carregando entidades e interface", () =>
                {
                    ...
                    pickaxeTexture = content.Load<Texture2D>("weapons/Pickaxe-Sheet");
                ...
                new BuildOperation.BuildStep("Posicionando spawns e finalizando sessao", () =>
                {
                    ...
                    Vector2 pickaxeSpawn = worldGenerator.GetSurfaceSpawnPosition(worldMap, itemSpawnTileX + 3, 2);
                    ...
                    worldItems = new List<WorldItem>
                    {
                        ...
                        new WorldItem(ItemDefinitions.Get(ItemId.Pickaxe), pickaxeTexture, pickaxeSpawn)
                    };
                    hotbar = new Hotbar(2);
